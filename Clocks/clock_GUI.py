...
def display_time():
    # using the strftime to represent current time in string
    ...
    # than and equal to 0 then set the value of the meridiem_label label to PM
    ...
    # converting 24-hours timer to 12-hours timer by
